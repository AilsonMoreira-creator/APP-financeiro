// ═══════════════════════════════════════════════════════════════════════════
// lojas-helpers-business.js — Helpers de regras de negócio do módulo Lojas
// (versão .js pra Edge Functions, copiada de src/LojasInstrucoes.jsx)
// ═══════════════════════════════════════════════════════════════════════════
//
// ⚠️ MANUTENÇÃO: esse arquivo é uma cópia EXATA das funções helpers do
//   src/LojasInstrucoes.jsx. Se editar aqui, edite lá também — ou vice-versa.
//
// Por que duplicado:
//   - Edge Functions Vercel não importam .jsx (sem transpiler de JSX)
//   - Mesmo padrão usado por api/lojas-ia-prompts.js (cópia dos prompts)
//
// Funções idênticas em ambos os arquivos (test em test/test-lojas.mjs):
//   refSemZero, normalizarTelefone, escolherTelefone, detectarLojaPorArquivo,
//   detectarCanal, calcularCanalDominante, ehVendaVarejo, resolverVendedora,
//   detectarClienteSinalizado, importarApelidoComprador, calcularFaseCicloVida,
//   classificarPedidoSacola, categorizarPagamento, calcularPerfilPresenca,
//   ehNovidadeReal, calcularJanelaNovidade, nomeModeloPorRef,
//   construirFraseProduto, calcularDiasSacola, temMovimentoRecenteSacola,
//   calcularStatusCliente, ehUsuarioAdmin
// ═══════════════════════════════════════════════════════════════════════════
