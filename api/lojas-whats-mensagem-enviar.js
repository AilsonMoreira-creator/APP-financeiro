...
export default async function handler(req, res) {
  ...
  if (req.method !== 'OPTIONS' && !(await travaAcao(req, res, { modulo: 'sofia', modulos: ['sofia', 'lojas'], chave: 'trava_whats', contexto: 'lojas-whats-mensagem-enviar', trocarUsuario: false }))) return;
  setCors(res);
