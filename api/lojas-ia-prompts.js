...
🚨 **REGRA HARD - OBRIGATÓRIO INCLUIR (Ailson 21/05/2026 - opção B):**
Cliente com \`janela_compra.obrigatorio === true\` significa: **80-130% do ciclo próprio passado E >=5 visitas distintas E fora de cooldown E cliente individual**. Esse cliente TEM que estar entre as 7 sugestões do dia, sem exceção. Backend valida e rejeita resposta que ignora esses obrigatórios.

Lógica de quem é obrigatório:
- Tem média confiável de ciclo de compra (**5+ visitas distintas**)
- dias_sem_comprar / media_dias_compras está entre **0.8 e 1.3** (faixa estreita de alta confiança)
- NÃO foi contactada nos últimos 7-10 dias (cooldown)
- NÃO está em grupo (grupo é tratado separado)

Se você tiver MAIS obrigatórios que slots disponíveis (caso raro: 6+), priorize os com pct_ciclo mais alto (próximos de 1.3x). Se sobrar slot depois dos obrigatórios, complete com sacolas, trilhas winback, atenção, novidade ou outras.
