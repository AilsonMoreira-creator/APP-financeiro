...
const inputStyle = {
  ...
  border: `1.5px solid ${palette.beige}`, fontFamily: FONT, fontSize: 13,
      ...
      <div style={{ padding: 16, paddingBottom: 32 }}>
        ...
        {ativas.length === 0 && (
          <div style={{
            ...
            fontSize: 13, marginBottom: 16, background: palette.surface,
            border: `1px dashed ${palette.beige}`, borderRadius: 10, lineHeight: 1.5,
          }}>
            <Gift size={36} color={palette.inkMuted} style={{ margin: '0 auto 12px', display: 'block', opacity: 0.4 }} />
            ...
            return (
              <div key={p.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 8 }}>
                  <Gift size={18} color={palette.warn} style={{ marginTop: 2, flexShrink: 0 }} />
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ fontSize: 10, color: palette.inkMuted, letterSpacing: 0.3, textTransform: 'uppercase' }}>
                      Vigência
                    </div>
                    <div style={{ fontSize: 12, color: palette.ink, fontWeight: 600, marginTop: 2 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: palette.accent, fontWeight: 600, marginTop: 2 }}>
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 4 }}>
                  ...
                  <button onClick={() => pausar(p)} disabled={pausando} style={{
                    ...
                    fontSize: 12, cursor: pausando ? 'wait' : 'pointer',
                    fontFamily: FONT, fontWeight: 600, opacity: pausando ? 0.6 : 1,
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4,
                  }}>
                    {pausando
                      ? <><Loader2 size={12} style={spinKeyframes} /> Pausando…</>
        ...
        <button onClick={() => setShowHistorico(!showHistorico)} style={{
          ...
          borderRadius: 10, padding: 12, cursor: 'pointer', fontFamily: FONT, fontSize: 13,
        ...
        {showHistorico && (
          <div style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: 6 }}>
            {carregandoHist && (
              <div style={{
                padding: 16, textAlign: 'center', color: palette.inkMuted, fontSize: 12,
                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
              }}>
                <Loader2 size={14} style={spinKeyframes} /> Carregando…
              </div>
            )}
            ...
            {historico.map((p) => (
              <div key={p.id} style={{
                ...
                <span style={{ fontSize: 11, color: palette.inkMuted, flexShrink: 0 }}>
...
export const NovaPromocaoScreen = ({ lojas, promocaoExistente = null, onBack, onSaved }) => {
  ...
  const Field = ({ label, children, hint }) => (
    <div style={{ marginBottom: 14 }}>
      <div style={{ fontSize: 12, fontWeight: 600, color: palette.inkSoft, marginBottom: 6 }}>{label}</div>
      {children}
      {hint && <div style={{ fontSize: 10, color: palette.inkMuted, marginTop: 4 }}>{hint}</div>}
    </div>
  );
  ...
  const Checkbox = ({ checked, onChange, label }) => (
    <label style={{
      ...
      cursor: 'pointer', fontSize: 13, color: palette.ink,
    }}>
    ...
    <div style={{ background: palette.bg, minHeight: '100%', fontFamily: FONT }}>
        ...
        <Field label="Vendedoras participantes" hint="Padrão: todas. (Por enquanto não persiste — todas vendedoras participam)">
          <div style={{
            ...
            {vendedorasReais.length === 0 && (
              <div style={{ fontSize: 12, color: palette.inkMuted, padding: 8, fontStyle: 'italic' }}>
      ...
      <div style={{
        ...
        <button onClick={salvar} disabled={salvando} style={btnPrimario(palette.warn, salvando)}>
          {salvando
            ? <><Loader2 size={15} style={spinKeyframes} /> Salvando…</>
            : <><Save size={15} /> {ehEdicao ? 'Salvar alterações' : 'Salvar promoção'}</>}
        </button>
      </div>
    </div>
  );
...
export const RegrasScreen = ({ lojas, onBack }) => {
  ...
  const ListaRegras = ({ items, onAdd, onRemove, novoValor, setNovoValor, placeholder, cor }) => (
    <div style={{
      ...
      {items.length === 0 && (
        <div style={{ fontSize: 12, color: palette.inkMuted, padding: 6, fontStyle: 'italic' }}>
      ...
      {items.map((item, i) => (
        <div key={i} style={{
          ...
          <span style={{ flex: 1, fontSize: 13, color: palette.ink }}>{item}</span>
          <button onClick={() => onRemove(i)} style={{
            background: 'transparent', border: 'none', cursor: 'pointer',
            padding: 4, display: 'flex',
          }}>
            <Trash2 size={14} color={palette.inkMuted} />
          </button>
        </div>
      ))}
      <div style={{
  ...
  if (carregando) {
    return (
      <div style={{ background: palette.bg, minHeight: '100%', fontFamily: FONT }}>
        ...
        <div style={{
          padding: 40, textAlign: 'center', color: palette.inkMuted, fontSize: 13,
          display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
        }}>
          <Loader2 size={16} style={spinKeyframes} /> Carregando configurações…
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{ background: palette.bg, minHeight: '100%', fontFamily: FONT }}>
      <Header
        ...
        rightContent={
          <button onClick={salvar} disabled={salvando} style={{
            ...
            {salvando
              ? <><Loader2 size={14} style={spinKeyframes} /> Salvando…</>
              : salvouOk
                ? <><Check size={14} /> Salvo!</>
                : <><Save size={14} /> Salvar</>}
          </button>
      ...
      <div style={{ padding: 16, paddingBottom: 32 }}>
        ...
        <div style={{ marginBottom: 14 }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: palette.inkSoft, marginBottom: 6 }}>
            Tom de comunicação
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 14 }}>
          <div>
            <div style={{ fontSize: 11, fontWeight: 600, color: palette.inkSoft, marginBottom: 6 }}>
              Desconto reativação
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
              <input type="number" value={descontoReat}
                onChange={e => setDescontoReat(e.target.value)} style={inputStyle} />
              <span style={{ fontSize: 14, color: palette.inkSoft }}>%</span>
            </div>
            <div style={{ fontSize: 10, color: palette.inkMuted, marginTop: 4 }}>
              Cliente 90+ dias
            </div>
          </div>
          <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 24 }}>
          {ativas.length === 0 && (
            <div style={{
              ...
              fontSize: 13, background: palette.surface,
              ...
              <div key={v.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
                  <div style={{
                    ...
                    <Users size={20} color={palette.inkSoft} />
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {Array.isArray(v.aliases) && v.aliases.length > 0 && (
                  <div style={{
                    fontSize: 11, color: palette.inkSoft, padding: '8px 0',
                    borderTop: `1px solid ${palette.beigeSoft}`,
                  }}>
                ...
                <div style={{ display: 'flex', gap: 6, marginTop: 8 }}>
                  ...
                  <button onClick={() => inativar(v)} disabled={inativando || ehPlaceholder} style={{
                    ...
                    {inativando
                      ? <><Loader2 size={12} style={spinKeyframes} /> …</>
                      : <><Pause size={12} /> Inativar</>}
                  </button>
                </div>
              </div>
            );
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {inativas.map(v => (
                <div key={v.id} style={{
                  ...
                  <Archive size={16} color={palette.archive} />
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 13, fontWeight: 600, color: palette.ink }}>{v.nome}</div>
    ...
    <div style={{ background: palette.bg, minHeight: '100%', fontFamily: FONT }}>
      ...
      <div style={{ padding: 16, paddingBottom: 100 }}>
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <div style={{ fontSize: 10, color: palette.inkMuted, marginBottom: 6 }}>
          ...
          <div style={{ marginBottom: 14 }}>
              ...
              {inativas.map(v => (
                <label key={v.id} style={{
                  ...
                  <input type="checkbox" checked={!!herda[v.id]}
                    ...
                    style={{ width: 16, height: 16, accentColor: palette.accent, cursor: 'pointer' }} />
                  <span>{v.nome} <span style={{ fontSize: 11, color: palette.inkMuted }}>(ex-vendedora)</span></span>
                </label>
              ))}
            </div>
            {Object.values(herda).some(Boolean) && (
              <div style={{
                ...
                borderRadius: 8, fontSize: 11, color: palette.ink, lineHeight: 1.5,
              }}>
      ...
      <div style={{
        ...
        <button onClick={salvar} disabled={salvando} style={btnPrimario(palette.ok, salvando)}>
          {salvando
            ? <><Loader2 size={15} style={spinKeyframes} /> Salvando…</>
            : <><Save size={15} /> {ehEdicao ? 'Salvar alterações' : 'Cadastrar'}</>}
        </button>
      </div>
    </div>
  );
    ...
    <div style={{ background: palette.bg, minHeight: '100%', fontFamily: FONT }}>
            ...
            {busca.length >= 2 && (
              <div style={{ marginBottom: 14, display: 'flex', flexDirection: 'column', gap: 6 }}>
                {resultadosBusca.length === 0 && (
                  <div style={{
                    padding: 12, textAlign: 'center', color: palette.inkMuted, fontSize: 12,
                ...
                {resultadosBusca.map(c => {
                  ...
                  return (
                    <button key={c.id} onClick={() => setClienteSel(c)} style={{
                      ...
                      <div style={{ fontSize: 13, fontWeight: 600, color: palette.ink, marginBottom: 2 }}>
                        {nomeCliente(c)}
                      </div>
                      {c.apelido && (
          ...
          <>
                  ...
                  return (
                    <label key={v.id} style={{
                      ...
                      <input type="checkbox" checked={!!origens[v.id]}
                        ...
                        style={{ width: 16, height: 16, accentColor: palette.accent, cursor: 'pointer' }} />
                      <span style={{ flex: 1 }}>{v.nome} <span style={{ fontSize: 11, color: palette.inkMuted }}>({qtd})</span></span>
                      {ehEx && (
                        <span style={{
                          fontSize: 10, color: palette.archive, padding: '2px 6px',
            ...
            {totalEmMassa > 0 && vendedoraDest && (
              <div style={{
                ...
                fontSize: 13, color: palette.ink, lineHeight: 1.5, marginBottom: 14,
              }}>
      ...
      <div style={{
        ...
        <button onClick={transferir} disabled={salvando} style={btnPrimario(palette.ok, salvando)}>
          {salvando
            ? <><Loader2 size={15} style={spinKeyframes} /> Transferindo…</>
            : <><ArrowLeftRight size={15} /> {modo === 'massa' ? 'Confirmar transferência' : 'Transferir'}</>}
        </button>
      </div>
    </div>
  );
      ...
      <div style={{ padding: 16, paddingBottom: 32 }}>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <button onClick={abrirModalAdicionar} style={{
            ...
            color: palette.accent, fontSize: 13, fontWeight: 600, marginBottom: 16,
            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
          }}>
          ...
          {itensDaAba.length === 0 && (() => {
            ...
            <div style={{
              ...
              {IconVazio && (
                <IconVazio size={36} color={palette.inkMuted}
              ...
              return (
                <div key={item.id} style={{
                  ...
                  <div style={{
                    ...
                    <Package size={18} color={palette.inkSoft} />
                  </div>

                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 10, color: palette.inkMuted, fontWeight: 600 }}>
                      REF {item.ref}
                    </div>
                    <div style={{
                    ...
                    {item.motivo && (
                      <div style={{
                        fontSize: 12, color: palette.inkSoft, fontStyle: 'italic', marginTop: 2,
                        overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
                      }}>
                        {item.motivo}
                      </div>
                    )}
                    <div style={{ fontSize: 10, color: palette.inkMuted, marginTop: 4, display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => remover(item)} disabled={removendo} style={{
                    ...
                    {removendo
                      ? <Loader2 size={16} style={spinKeyframes} color={palette.inkMuted} />
        ...
        <div style={{
          ...
          borderRadius: 10, fontSize: 11, color: palette.inkSoft, lineHeight: 1.6,
        }}>
        ...
        <div style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: 15, fontWeight: 600, color: palette.ink }}>
            ...
            <div style={{ padding: 20, overflowY: 'auto', flex: 1 }}>
              <div style={{
                ...
                <Search size={14} color={palette.inkMuted} />
                  ...
                  return (
                    <button key={p.ref} onClick={() => setProdutoSel(p)} style={{
                      ...
                      <div style={{
                        ...
                        {sel && <Check size={12} color={palette.bg} />}
                      </div>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: 10, color: palette.inkMuted, fontWeight: 600 }}>
                          REF {p.ref}
    ...
    <div style={{ background: palette.bg, minHeight: '100%', fontFamily: FONT }}>
      ...
      <div style={{ padding: 16, paddingBottom: 32 }}>
        ...
        {ultima ? (
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
              {statusGeral === 'ok'
                ? <CheckCircle2 size={18} color={palette.ok} />
          ...
          <div style={{
            padding: 20, textAlign: 'center', color: palette.inkMuted, fontSize: 13,
            background: palette.surface, border: `1px dashed ${palette.beige}`,
            borderRadius: 10, marginBottom: 16, lineHeight: 1.5,
          }}>
            <FileSpreadsheet size={32} color={palette.inkMuted}
              style={{ margin: '0 auto 12px', display: 'block', opacity: 0.4 }} />
        ...
        <button onClick={onUploadManualClick} style={{
          ...
          color: palette.accent, fontSize: 13, fontWeight: 600, marginBottom: 24,
          display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
        }}>
          <Upload size={16} />
              ...
              {importacoes.map(imp => {
                ...
                return (
                  <div key={imp.id} style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                      <FileSpreadsheet size={14} color={palette.inkSoft} />
                      <span style={{ fontSize: 13, fontWeight: 600, color: palette.ink, flex: 1, minWidth: 0 }}>
                      ...
                      {ok
                        ...
                        : erro
                          ? <AlertCircle size={14} color={palette.alert} />
                          : <AlertCircle size={14} color={palette.warn} />}
                    </div>
    ...
    <div style={{ background: palette.bg, minHeight: '100%', fontFamily: FONT }}>
      ...
      <div style={{ padding: 16, paddingBottom: 32 }}>
              ...
              <button key={g.id} onClick={() => onSelectGrupo(g)} style={{
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4, flexWrap: 'wrap' }}>
                    <span style={{ fontSize: 15, fontWeight: 600, color: palette.ink }}>{g.nome_grupo}</span>
                    <span style={{
                  ...
                  {isAdmin && vendedora && (
                    <div style={{
                      fontSize: 10, color: palette.inkMuted, marginBottom: 4,
                      display: 'flex', alignItems: 'center', gap: 4,
                    }}>
                      <Users size={10} /> {vendedora.nome} · {vendedora.loja}
                    </div>
                  )}
        ...
        {gruposAgregados.length === 0 && !busca && (
          <div style={{
            padding: 32, textAlign: 'center', color: palette.inkMuted,
            fontSize: 13, marginTop: 12, background: palette.surface,
            border: `1px dashed ${palette.beige}`, borderRadius: 10, lineHeight: 1.5,
          }}>
            <UsersRound size={36} color={palette.inkMuted}
              style={{ margin: '0 auto 12px', display: 'block', opacity: 0.4 }} />
    ...
    <div style={{ background: palette.bg, minHeight: '100%', fontFamily: FONT }}>
      ...
      <div style={{ padding: 16, paddingBottom: 100 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
            <div style={{
              ...
              <UsersRound size={22} color={palette.accent} />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 2, flexWrap: 'wrap' }}>
                <span style={{ fontSize: 16, fontWeight: 600, color: palette.ink }}>{grupo.nome_grupo}</span>
                <span style={{
                  fontSize: 9, fontWeight: 600, padding: '2px 6px', borderRadius: 4,
                  background: meta.soft, color: meta.cor,
                  letterSpacing: 0.3, textTransform: 'uppercase',
          ...
          {grupo.documentos.map((d, i) => {
            ...
            return (
              <div key={d.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4, flexWrap: 'wrap' }}>
                  {ehPrincipal && <Crown size={14} color={palette.warn} style={{ flexShrink: 0 }} />}
                  <span style={{ fontSize: 13, fontWeight: 600, color: palette.ink, flex: 1, minWidth: 0 }}>
                    {nomeCliente(d)}
                  </span>
                  <span style={{
                ...
                {ehPrincipal && (
                  <div style={{
                    marginTop: 6, fontSize: 10, color: palette.warn, fontWeight: 600,
                    letterSpacing: 0.3, textTransform: 'uppercase',
        ...
        <button onClick={onAdicionarCnpj} style={{
          ...
          <Plus size={15} /> Adicionar CNPJ ao grupo
        </button>
              ...
              return (
                <div key={m.id} style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                    <Icone size={14} color={visual.cor} />
    ...
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{
                ...
                <UsersRound size={18} color={palette.accent} />
              </div>
              <div style={{ fontSize: 15, fontWeight: 600, color: palette.ink }}>
        ...
        <div style={{ padding: 20, overflowY: 'auto', flex: 1 }}>
                    ...
                    <button key={c.id} onClick={() => {
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {c.apelido && c.razao_social && (
                          <div style={{
                            fontSize: 11, color: palette.inkMuted, marginTop: 1,
                            overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
                          }}>
                            {c.razao_social}
                          </div>
          ...
          {step === 2 && (
            <>
              ...
              <div style={{ marginTop: 16, fontSize: 11, color: palette.inkMuted, marginBottom: 6 }}>
              ...
              <div style={{
                ...
                {docsSelecionados.map(d => (
                  <div key={d.id} style={{
                    fontSize: 12, color: palette.inkSoft, padding: '4px 0',
                    display: 'flex', alignItems: 'center', gap: 6,
                  }}>
                    <Store size={11} color={palette.inkMuted} />
          ...
          {step === 3 && (
            <>
                ...
                {docsSelecionados.map(d => {
                  ...
                  return (
                    <button key={d.id} onClick={() => setDocPadrao(d.id)} style={{
                      ...
                      <Crown size={16} color={isPadrao ? palette.warn : palette.beige} />
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{
                          fontSize: 13, fontWeight: 600, color: palette.ink,
                          overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
              ...
              <div style={{
                ...
                borderRadius: 8, fontSize: 12, color: palette.ink, lineHeight: 1.6,
              }}>
              ...
              <div style={{
                ...
                fontSize: 10, color: palette.inkMuted, lineHeight: 1.5,
              }}>
        ...
        <div style={{
          ...
          {step > 1 && (
            <button onClick={() => setStep(step - 1)} disabled={salvando} style={{
              flex: 1, background: palette.surface, color: palette.inkSoft,
              border: `1.5px solid ${palette.beige}`, borderRadius: 10, padding: '12px',
              fontSize: 13, cursor: salvando ? 'wait' : 'pointer',
              fontFamily: FONT, fontWeight: 600,
            }}>Voltar</button>
          )}
          {step < 3 ? (
            ...
            <button onClick={criar} disabled={salvando} style={{
              ...
              {salvando
                ? <><Loader2 size={15} style={spinKeyframes} /> Criando…</>
                : <><Check size={15} /> Criar grupo</>}
            </button>
          )}
        </div>
        ...
        {step === 1 && selecionados.length === 1 && (
          <div style={{
            padding: '0 16px 12px', fontSize: 11, color: palette.inkMuted, textAlign: 'center',
          }}>
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{
          ...
          <div style={{ minWidth: 0, flex: 1 }}>
            ...
            <div style={{
              fontSize: 11, color: palette.inkMuted, marginTop: 2,
              overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
            }}>
        ...
        <div style={{
          ...
          <button onClick={adicionar}
            ...
            {salvando
              ? <><Loader2 size={15} style={spinKeyframes} /> Adicionando…</>
              : <><Link2 size={15} /> Adicionar{selecionados.length > 0 ? ` (${selecionados.length})` : ''}</>}
          </button>
        </div>
      </div>
    </div>
