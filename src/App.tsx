...
const EstoqueView=({sbUrl,handleZoom,produtos=[]})=>{
  ...
  return(<div>
    ...
    {modalRef&&selectedRef&&(()=>{
      ...
      {saleOpen && <MLSale refProduto={saleOpen.ref} desc={saleOpen.desc} contasVerdes={saleOpen.contas||[]} conta={(saleOpen.contas||[]).includes('exitus')||!(saleOpen.contas||[]).length?'exitus':saleOpen.contas[0]} onClose={()=>{setSaleOpen(null);carregarSaleBadges();/* 20/09: abrir a tela carrega promocoes novas -> o verde do card atualiza ao fechar */}} onMudou={carregarSaleBadges}/>}
      {gtinOpen && (
